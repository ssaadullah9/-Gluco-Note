          ...
          if (!snapshot.hasData) {
            ...
            return ListView(
              ...
              children: [
                ...
                TextFormField(
                  controller: TextEditingController(text: controller.UName),
                ...
                TextFormField(
                  readOnly: true,
                  controller: TextEditingController(text: controller.UDOB),
                    ...
                    suffixIcon: IconButton(
                      onPressed: () async {
                        ...
                        if (pickedDate != null) {
                          ...
                          setState(() {});
                          print(controller
                              .UDOB); //formatted date output using intl package =>  2021-03-16

                        } else {
                          print(LocaleKeys.date_not_selected.tr);
                        }
                      },
                      icon: Icon(
                        Icons.cake,
                ...
                TextFormField(
                  controller: TextEditingController(text: controller.UPhone),
