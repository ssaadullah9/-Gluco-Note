              ...
              children: [
                DropdownButtonFormField(
                  decoration: InputDecoration(
                      labelText: LocaleKeys.antidiabetic.tr,
                      border: OutlineInputBorder()),
                  items: [LocaleKeys.yes.tr, LocaleKeys.no.tr]
                  ...
                  hint: Text(
                    controller.user_AntiD == null
                        ? ""
                        : "${controller.user_AntiD}",
                  ),
                ),
                SizedBox(
                ...
                DropdownButtonFormField(
                  decoration: InputDecoration(
                      labelText: LocaleKeys.insulin.tr,
                      border: OutlineInputBorder()),
                  items: [LocaleKeys.yes.tr, LocaleKeys.no.tr]
                      .map((e) => DropdownMenuItem(
                    child: Text("$e"),
                  ...
                  hint: Text(
                    controller.user_insulin == null
                        ? ""
                        : "${controller.user_insulin}",
                  ),
                ),
                SizedBox(
                  height: Get.width * 0.06,
                ...
                DropdownButtonFormField(
                  decoration: InputDecoration(
                      labelText: LocaleKeys.injectable.tr,
                      border: OutlineInputBorder()),
                  items: [LocaleKeys.yes.tr, LocaleKeys.no.tr]
                      .map((e) => DropdownMenuItem(
                    child: Text("$e"),
                  ...
                  hint: Text(
                    controller.user_injectable == null
                        ? ""
                        : "${controller.user_injectable}",
                  ),
                ),
                SizedBox(
                  height: Get.width * 0.06,
                ...
                DropdownButtonFormField(
                  decoration: InputDecoration(
                      labelText: LocaleKeys.nutrition.tr,
                      border: OutlineInputBorder()),
                  items: [LocaleKeys.yes.tr, LocaleKeys.no.tr]
                      .map((e) => DropdownMenuItem(
                    child: Text("$e"),
                  ...
                  hint: Text(
                    controller.user_nutrition == null
                        ? ""
                        : "${controller.user_nutrition}",
                  ),
                ),
                SizedBox(
                  height: Get.width * 0.06,
                ...
                _buildDateSelected(
                    text: LocaleKeys.tg_date.tr,
                    context: context,
                    selectDate: controller.selectedLDLDates,
                    showText: controller.user_LDLDate == null
                        ? null
                        : controller.user_LDLDate),
                SizedBox(
                  height: Get.width * 0.06,
                ),
                TextFormField(
                  initialValue:
                  controller.user_TG == null ? " " : controller.user_TG,
                  style: TextStyle(color: Colors.black),
                  keyboardType: TextInputType.numberWithOptions(),
                  decoration: InputDecoration(
                    border: OutlineInputBorder(),
                ...
                _buildDateSelected(
                    ...
                    showText: controller.user_TGDate == null
                        ? null
                        : controller.user_TGDate),
                SizedBox(
                  height: Get.width * 0.06,
                ),
                TextFormField(
                  initialValue: controller.user_ALBUMIN == null
                      ? " "
                      : controller.user_ALBUMIN,
                  style: TextStyle(color: Colors.black),
                  keyboardType: TextInputType.numberWithOptions(),
                  decoration: InputDecoration(
                    border: OutlineInputBorder(),
                ...
                _buildDateSelected(
                    ...
                    showText: controller.user_ALBUMINDate == null
                        ? null
                        : controller.user_ALBUMINDate),
                SizedBox(
                  height: Get.width * 0.06,
                ),
                Container(
    ...
    return TextFormField(
      ...
      validator: (value) {
        if (value == null || value.isEmpty) {
          return LocaleKeys.enter_date.tr;
        }
        return null;
      },
    );
